...
export default {
  ...
  methods:{
    setImage(e){
      ...
      UserService.uploadAvatarToUser(this.image);
    },

    async updateUser(){
      UserService.updateUser(this.username).then(response => {
...
<template>
  <div class="profile">
    ...
    <div class="field">
      <h3 class="field__title">Username (optional)</h3>
      <p class="field__text">
        Set a username.
      </p>
      <input class="field__input" placeholder="Username (optional)" @keyup.enter="updateUser" type="text" v-model="username">
    ...
    <div class="field">
      <h3 class="field__title">About</h3>
      <p class="field__text">
        Set an about.
      </p>
      <textarea class="field__input" placeholder="About (optional)" v-model="about"></textarea>
      <span class="field__help">
